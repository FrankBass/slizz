...
<div class="feed"style="position: relative;">
    <div class="head">
      ...
      <a  href="<?php echo $retweeted_user->username; ?> "> <?php  if($retweeted_user->id == $user_id) echo "You";
      ...
      <div class="user">
      <a href="<?php echo $tweet_user->username;  ?>">
      ...
      <div>
      <p>
      <a style="position: relative; z-index:5; color:black" href="<?php echo $tweet_user->username;  ?>">
      ...
      <p class="tweet-links"style="position:relative;word-break: break-word;">
      <?php
      ...
      <a href="<?php echo $user_inner_tweet->username;  ?>">
      <img
