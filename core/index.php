...
<html>
    ...
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v2.1.6/css/unicons.css">
        ...
        <link rel="stylesheet" href="assets/css/bootstrap.min.css">
           ...
           <!-- logos dans longlet -->
		<link rel="shortcut icon" type="" href="assets/images/twitter.">
	</head>
<body>
<main class="twt-main">
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                               ...
                               <!-- logos sur la page -->
                        <img class="" src="<?php echo BASE_URL . "/assets/images/"; ?>" alt="">
                        ...
                        <span class="join">Join SLIZ community.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li style="color:#495057;"><b>- Developer By Frank Bassilekin & Tachrifa Hamada -</b></li>
                </ul>
            </footer>
        </main>
